...
def fn_member_collection(driver):
    ...
    for r in range(2, rows+1):
        ...
        driver.refresh()
        """Reading data"""
        route_value = XLUtility.readData(file, "data", r, 1)
        mpp_value = XLUtility.readData(file, "data", r, 2)
        date_value = XLUtility.readData(file, "data", r, 3)
        # shift_value = XLUtility.readData(file, "data", r, 4)
        member_value = XLUtility.readData(file, "data", r, 5)
        type_value = XLUtility.readData(file, "data", r, 6)
        quantity_value = XLUtility.readData(file, "data", r, 7)
        fat_value = XLUtility.readData(file, "data", r, 8)
        snf_value = XLUtility.readData(file, "data", r, 9)
